    ...
    <div className="group">
      <div
        ...
        style={{
          ...
          borderRadius: '13px',
          boxShadow: isHovered ? '0 4px 12px var(--color-primary-light)' : '0 1px 3px var(--color-shadow)'
        }}
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
      >
        {/* Header */}
        <div style={{ height: '3px', backgroundColor: 'var(--color-primary)' }}></div>
        ...
        <div className="p-5">
          ...
          <div className="flex items-start justify-between gap-3 mb-3">
            <div
              ...
              title={tool.URL ? t('toolCard.clickToVisit') : ''}
            >
          ...
          <div className="flex flex-wrap gap-1.5 mb-4">
            ...
            {tool.Open_Source === 'Yes' && (
              <span className="px-2 py-0.5 text-xs rounded font-medium" style={{ backgroundColor: 'var(--color-primary-light)', color: 'var(--color-primary)', borderRadius: '8px' }}>
          ...
          {isExpanded && (
            <div className="mb-4 space-y-3">
              ...
              {tool.Strengths && (
                <div>
                  <div className="flex items-center gap-1.5 mb-1">
                    <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24" style={{ color: 'var(--color-good)' }}>
                      <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" />
                    </svg>
                    <span className="text-xs font-semibold" style={{ color: 'var(--color-good)' }}>{t('toolCard.strengths')}</span>
                  </div>
              ...
              {tool.Limitations && (
                <div>
                  <div className="flex items-center gap-1.5 mb-1">
                    <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24" style={{ color: 'var(--color-bad)' }}>
                      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" />
                    </svg>
                    <span className="text-xs font-semibold" style={{ color: 'var(--color-bad)' }}>{t('toolCard.limitations')}</span>
                  </div>
